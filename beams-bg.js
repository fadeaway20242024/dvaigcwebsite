/**
 * React Bits Beams — vanilla Three.js port for hero background.
 * @see https://reactbits.dev/backgrounds/beams
 */
...
export function initBeams(container, options = {}) {
  ...
  const loop = (t) => {
    ...
    const delta = lastTime ? (t - lastTime) / 1000 : 0;
    lastTime = t;
...
const mountEl = document.getElementById("hero-beams");
if (mountEl) {
  initBeams(mountEl);
}
